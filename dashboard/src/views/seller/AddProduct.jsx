        ...
        <div className='px-2 lg:px-7 pt-5 '>
            <div className='w-full p-4 bg-[#6a5fdf] rounded-md'>
                <div className='flex justify-between items-center pb-4'>
                    ...
                    <Link to='/seller/dashboard/products' className='bg-blue-500 hover:shadow-blue-500/10 hover:shadow-lg text-white rounded-sm px-7 py-2'>
                        All Product
                    </Link>
                </div>
                <div>
                        ...
                        <div className='grid lg:grid-cols-4 grid-cols-1 md:grid-cols-3 sm:grid-cols-3 sm:gap-4 md:gap-4 gap-3 w-full text-[#d0d2d6] mb-4'>
                            {imageShow.map((img, i) => (
                                <div key={i} className='h-[180px] relative'>
                                    ...
                                    <span onClick={() => removeImage(i)} className='p-2 z-10 cursor-pointer bg-red-700 hover:shadow-lg hover:shadow-slate-400/50 text-white absolute top-1 right-1 rounded-full'><IoMdCloseCircle /></span>
                                </div>
                            ))}
