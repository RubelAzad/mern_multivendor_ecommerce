...
const SellerRequest = () => {
    ...
    return (
        <div className='px-2 lg:px-7 pt-5'>
            <h1 className='text-[25px] font-semibold text-lg mb-2'>Seller Request</h1>
                                ...
                                <tbody>
                                    {
                                        [1,2,3,4,5].map((item, index) =>
                                            <tr className='border-b border-slate-700' key={index}>
                                                <td className='px-4 py-2 font-medium whitespace-nowrap'>{item}</td>
                                                <td className='px-4 py-2 font-medium whitespace-nowrap'>Abul Kalam Azad</td>
                                                <td className='px-4 py-2 font-medium whitespace-nowrap'>rubelazad123@gmail.com</td>
                                                <td className='px-4 py-2 font-medium whitespace-nowrap'>Pending</td>
